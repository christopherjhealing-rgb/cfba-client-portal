  ...
  return (
    <div className="card mb-8 p-4">
      ...
      <p className="mt-1 max-w-2xl text-[13px] leading-relaxed text-ink/60">
        Dormant. When on, clients can reach the checker at
        <span className="font-mono"> /engineering</span>. Per-client span-table
        sets aren&apos;t wired yet — leave off until the tables and access rules
        are ready.
      </p>
