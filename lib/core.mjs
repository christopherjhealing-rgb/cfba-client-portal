...
// days, never a forecast. Public holidays are not accounted for, so the figure
// is a floor: it can understate the wait but never overstate it.
// ---------------------------------------------------------------------------
export function businessDaysSince(iso, now = new Date()) {
