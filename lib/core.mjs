...
const CLIENT_LABELS = {
  ...
  "To FIR": "We require further information — an email will be sent shortly with the details",
  "FIR": "Waiting on further information from you",
...
export function clientStatusLabel(mondayStatus) {
...
//
// Fixed-date WA holidays are seeded below. Add the MOVABLE ones each year —
// Labour Day (1st Mon Mar), Good Friday, Easter Monday, WA Day (1st Mon Jun),
// King's Birthday (WA, late Sep) — and any observed-substitute days. A missing
// date just means that day counts as a working day (the old behaviour), so an
// incomplete list is safe, only slightly generous.
// ---------------------------------------------------------------------------
export const WA_PUBLIC_HOLIDAYS = new Set([
  // 2026 (fixed-date)
  "2026-01-01", "2026-01-26", "2026-04-25", "2026-12-25", "2026-12-28", // 26th is a Sat → 28th observed
  // 2026 movable — CONFIRM and complete:
  "2026-03-02", // Labour Day (WA)
  // "2026-04-03", "2026-04-06", // Good Friday, Easter Monday — confirm
  "2026-06-01", // WA Day
  // "2026-09-28", // King's Birthday (WA) — confirm
  // 2027 (fixed-date)
  "2027-01-01", "2027-01-26", "2027-04-26", "2027-12-27", "2027-12-28", // Anzac/Xmas/Boxing observed
]);
