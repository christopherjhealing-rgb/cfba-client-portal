...
//
// On the edition: NCC 2022 adopts AS 4055:2021 and AS/NZS 1170.2:2021, and WA
// carries its own variation for wind Regions B and D. This module is built on
// the 2013 Stratco guide and therefore the 2012/2011 editions. Chris weighed
// that up on 3 Aug 2026 and kept it — the screen names both editions, and the
// classification for a real job comes off our certificate, not off here. Worth
// revisiting only if the tables themselves moved between editions.
