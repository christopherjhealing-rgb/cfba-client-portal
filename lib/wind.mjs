...
export const REGIONS = [
  { key: "A", label: "Region A", note: "Most of inland and southern WA, including Perth." },
  { key: "B", label: "Region B", note: "The intermediate coastal strip." },
  { key: "C", label: "Region C", note: "Cyclonic. The north-west coast." },
  { key: "D", label: "Region D", note: "Severe cyclonic. The most exposed north-west coast." },
];
