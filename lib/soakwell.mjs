...
//
// Chris decided on 3 Aug 2026 to use 0.0125 across the board rather than let
// the rate vary, so the screen has no control for it and every job is sized on
// the one figure we have read off a council's own sheet. The rate survives as
// a defaulted parameter — the seam, tested, ready for the day real council
// figures arrive — but nothing in the product turns it. The screen still says
// councils differ and still says ask us, because that is true whether or not
// there is a knob for it.
...
export const SOAKWELL_CAVEAT =
  ...
  "as much again as others. This sizes on the City of Bayswater's published " +
  "figure throughout. Check it against your own council before it goes on a " +
  "plan, or ask us and we'll tell you what they expect. Capacities are the " +
  "nominal figures on the sheet; your supplier's own capacity for the well " +
  "you buy is the one that counts.";
