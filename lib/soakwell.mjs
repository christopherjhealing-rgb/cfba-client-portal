...
//
// On the rate: 0.0125 m³/m² is 12.5 mm of rain retained on site. Councils in
// Perth vary, and some publish their own tables — see SOAKWELL_CAVEAT, which
// every screen using this module has to show.
...
export const SOAKWELL_CAVEAT =
  "Perth councils vary on the design storm they require, and some publish " +
  "their own sizing tables. This uses Bayswater's rate of 12.5 mm retained on " +
  "site — check your own council, or ask us and we'll tell you what they " +
  "expect. Capacities are the nominal figures on the sheet; your supplier's " +
  "own capacity for the well you buy is the one that counts.";
