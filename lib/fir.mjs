...
export const FIR_ITEMS = [
  ...
  { code: "bal", group: "The site",
    ...
    body: "A Bushfire Attack Level (BAL) assessment for the site. This lot is in a designated bushfire prone area, so the assessment cannot be completed without one. We can prepare a BAL assessment for you if that would be easier — just ask." },
